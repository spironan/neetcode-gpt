...
class Solution:
    def reshape(self, to_reshape: TensorType[float]) -> TensorType[float]:
        ...
        new_shape = (to_reshape.shape[0] * to_reshape.shape[1]//2, 2)
        return to_reshape.reshape(new_shape).round(decimals=4)
        #return torch.reshape(to_reshape, new_shape).round(decimals=4)
        pass
